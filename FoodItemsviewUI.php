											...
											if(!empty($Result_FoodItems)) {
												foreach ($Result_FoodItems as $row) {
													...
													<tr>
													  ...
													  <td>
													  <a href="FoodItemsviewUI.php?FoodID=<?php echo $ID;?>&FoodcatID=<?php echo $CategoryID;?>">
													  ...
													  <td>  <a href="FoodItemsviewUI.php?FoodID=<?php echo $ID;?>&FoodcatID=<?php echo $CategoryID;?>">Add sub food</a></td>
